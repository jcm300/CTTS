...
\section{Conclusão}
Em conclusão apesar do trabalho ser feito com o objetivo de palavras cinematográficas, pode-se contudo usar palavras de qualquer área. Para além disso o processamento das palavras é case insencitive ou seja, identifica as palavras independentemente sejam maiusculas ou minusculas, apenas interessa o ``signficado''. É também permitido via flag decidir qual o nome de sáida de cada ficheiro. É, por fim, importante referir que as ferramentas usadas(Flex e Yacc) aliadas à linguagem de programação C, dão-nos um grande poder de decisão e de desenvolvimento em que a realização de aplicação torna-se mais rápida, mais simples e mais fácil de se construir.
